    ...
    <div>
      <div className="relative">
        ...
        <div className="absolute top-32">
          ...
          <div className="px-20 grid grid-cols-3 text-white mt-8 gap-5">
      ...
      <div className="px-20 -mt-40 relative">
        <div className="grid grid-cols-3 shadow-xl">
          ...
          <div className="p-10 flex flex-col gap-6 bg-white text-[#525252]">
            ...
            <p>
              Uniform, T-shirt, Polo T-shirt, Jacket, Vest, Apron, Hat, Banner,
              Backpack, Bag, Tote Bag, Packaging, etc
            </p>
          </div>
        </div>
      </div>
